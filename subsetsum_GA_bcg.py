...
def test_driver(filename):
    ...
    os.chdir("C:\\Users\\bengo\\OneDrive\\Coding\\EvoComputing")

    with open(filename) as file:
      for line in file:
        num_list.append(int(line))

    generation_cap = int(input("Set the maximum number of generations: "))
    num_sum = int(input("Please enter a target: "))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if userin.upper() == "Y":
            ...
            fittest = subsetsum(num_list, num_sum, generation_cap)
            print("The best solution was {} and it was found in generation {}.".format(fittest[0], fittest[1]))
            break
        else:
